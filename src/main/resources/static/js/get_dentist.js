        ...
        fetch(url,settings)
            ...
            .then(data => {
                ...
                for(dentist of data){
                    ...
                    //por cada odontólogo creamos un botón delete que agregaremos en cada fila par poder eliminar
                    //dicho botón invocará a la función de js deleteBy que se encargará
                    ...
                    dentistRow.innerHTML =
                        '<td><button id="btn_id_' + dentist.id + '" onclick="findBy(' + dentist.id + ')" class="btn btn-info btn_id">' + dentist.id + '</button></td>' +
                        ...
                        '<td><button id="btn_delete_' + dentist.id + '" onclick="deleteBy(' + dentist.id + ')" class="btn btn-danger btn_delete">&times;</button></td>';
